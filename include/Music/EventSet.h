...
public:
   ...
   */
  [[nodiscard]] bool AtCapacity() const { return size() >= Capacity() - 1; }
   ...
   * in the timeline. This function uses the GetEventIndexForPulse method to
   ...
   * are hits based on the IsHit trait defined for the event type. The density
   ...
   * the current count of events) to avoid undefined behavior. The IsHit
