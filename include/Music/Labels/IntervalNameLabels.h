...
namespace Music
{
    ...
    static const char *i_n2     = "n2";
    static const char *i_dM2    = "dM2";
    static const char *i_M2     = "M2";
    static const char *i_A2     = "A2";

    static const char *i_m3     = "m3";
    static const char *i_n3     = "n3";
    static const char *i_M3     = "M3";
    static const char *i_sM3    = "sM3";
    ...
    static const char *i_n6     = "n6";
    static const char *i_M6     = "M6";
    static const char *i_sM6    = "sM6";
    static const char *i_A6     = "A6";

    static const char *i_m7     = "m7";
    static const char *i_n7     = "n7";
