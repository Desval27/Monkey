...
// clang-format off
    ...
    static const char *n_Csdn_Dbup  = "C#v/Db^";
    static const char *n_Cs_Ddn     = "C#/Dv";
    static const char *n_Cs         = "C#";
    static const char *n_Cs_Db      = "C#/Db";
    static const char *n_Db         = "Db";

    static const char *n_D          = "D";
    static const char *n_Dup_Eb     = "D^/Eb";
    static const char *n_Dsdn_Ebup  = "D#v/Eb^";
    static const char *n_Ds_Edn     = "D#/Ev";
    ...
    static const char *n_Fup_Gb     = "F^/Gb";
    static const char *n_Fsdn_Gbup  = "F#v/Gb^";
    static const char *n_Fs_Gdn     = "F#/Gv";
    static const char *n_Fs         = "F#";
    static const char *n_Fs_Gb      = "F#/Gb";
    static const char *n_Gb         = "Gb";

    static const char *n_G          = "G";
    static const char *n_Gup_Ab     = "G^/Ab";
    static const char *n_Gsdn_Abup  = "G#v/Ab^";
    static const char *n_Gs_Adn     = "G#/Av";
    static const char *n_Gs         = "G#";
    static const char *n_Gs_Ab      = "G#/Ab";
    static const char *n_Ab         = "Ab";

    static const char *n_A          = "A";
    static const char *n_Aup_Bb     = "A^/Bb";
    static const char *n_Asdn_Bbup  = "A#v/Bb^";
    static const char *n_As_Bdn     = "A#/Bv";
